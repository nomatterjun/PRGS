...
func solution(_ a:Int, _ b:Int, _ n:Int) -> Int {
    return payback(a, b, n, total: 0)
}

// a: 줘야할 병, b: 마트가 주는 병, n: 갖고 있는 빈 병
func payback(_ a: Int, _ b: Int, _ n: Int, total: Int) -> Int {
    if n < a { return total }
    return payback(a, b, ((n / a) * b) + (n % a), total: total + (n / a * b))
}
...
func solution(_ a:Int, _ b:Int, _ n:Int) -> Int {
    let newCoke = b * (n / a)
    return n < a ? 0 :
        newCoke + solution(a, b, newCoke + n % a)
}
