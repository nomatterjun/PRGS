...
func solution(_ survey:[String], _ choices:[Int]) -> String {
    ...
    survey.enumerated().forEach { idx, sv in
        if choices[idx] > 4 {
            dict[sv.last!, default: 0] += choices[idx] - 4
        } else {
            dict[sv.first!, default: 0] += 4 - choices[idx]
        }
    }
    
    var sol = ""
    sol += dict["R", default: 0] >= dict["T", default: 0] ? "R" : "T"
    sol += dict["C", default: 0] >= dict["F", default: 0] ? "C" : "F"
    sol += dict["J", default: 0] >= dict["M", default: 0] ? "J" : "M"
    sol += dict["A", default: 0] >= dict["N", default: 0] ? "A" : "N"
    return sol
}